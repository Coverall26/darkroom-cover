          ...
          <div className="flex items-center justify-between gap-2">
            <Tabs value={mode} onValueChange={(v) => setMode(v as 'draw' | 'type')} className="w-auto">
              <TabsList className="grid w-full grid-cols-2 bg-gray-800">
                <TabsTrigger value="draw" className="data-[state=active]:bg-gray-700 min-h-[44px]">
                  <PenTool className="h-4 w-4 mr-2" />
                  Draw
                </TabsTrigger>
                <TabsTrigger value="type" className="data-[state=active]:bg-gray-700 min-h-[44px]">
                ...
                <>
                  <Popover>
                    <PopoverTrigger asChild>
                      <Button variant="ghost" size="sm" className="text-gray-400 hover:text-white min-h-[44px] min-w-[44px] p-2">
                  ...
                  <Button
                    ...
                    className="text-gray-400 hover:text-white disabled:opacity-30 min-h-[44px] min-w-[44px] p-2"
        ...
        {mode === 'type' && (
          <div className="space-y-3">
            <Input
              ...
              className="bg-gray-800 border-gray-600 text-white text-base sm:text-sm"
            ...
            <div className="flex gap-2 flex-wrap" role="radiogroup" aria-label="Select signature font style">
              {signatureFontOptions.map((option) => (
                <button
                  ...
                  className={cn(
                    "px-3 py-2 min-h-[44px] rounded text-sm transition-all",
