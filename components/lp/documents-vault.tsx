...
import { EncryptedDownloadButton } from "@/components/documents/encrypted-download-button";
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3 min-w-0 flex-1">
                    <div className={`p-2 bg-gray-600/50 rounded-lg relative`}>
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2">
                        ...
                        {doc.isClientEncrypted && (
                          <span className="shrink-0 inline-flex items-center gap-1 px-1.5 py-0.5 bg-emerald-500/20 text-emerald-400 rounded text-[10px] font-medium">
                    ...
                    {doc.fileUrl && (
                      <>
                        <SaveOfflineButton
                          ...
                          variant="icon"
                        />
                        {doc.isClientEncrypted && doc.encryptionIv ? (
