      ...
      <CardContent className="pt-4">
        <div className="grid grid-cols-2 gap-4 mb-5">
          <div className="p-3 bg-gray-700/30 rounded-lg">
            ...
            <div className="text-white font-semibold text-lg font-mono tabular-nums">
        ...
        <div className="space-y-3 mb-5">
          <div>
            <div className="flex justify-between text-sm mb-1.5">
              ...
              <span className="text-emerald-400 font-medium font-mono tabular-nums">{investment.fundedPercentage}%</span>
            </div>
          ...
          <div>
            <div className="flex justify-between text-sm mb-1.5">
              ...
              <span className="text-blue-400 font-medium font-mono tabular-nums">{metrics.raiseProgress}%</span>
            </div>
            <div className="w-full bg-gray-700 rounded-full h-2">
              <div
            ...
            <div className="flex justify-between text-xs text-gray-500 mt-1 font-mono tabular-nums">
            ...
            <div className="space-y-2">
              {fund.recentDistributions.slice(0, 2).map((dist) => (
                <div key={dist.id} className="flex items-center justify-between p-2 bg-emerald-500/10 rounded-lg">
                  ...
                  <span className="text-emerald-400 font-medium font-mono tabular-nums">{formatCurrency(dist.amount)}</span>
                </div>
              ))}
            </div>
          </div>
            ...
            <div className="space-y-2">
              {fund.recentCapitalCalls.slice(0, 2).map((call) => (
                <div key={call.id} className="flex items-center justify-between p-2 bg-amber-500/10 rounded-lg">
                  ...
                  <span className="text-amber-400 font-medium font-mono tabular-nums">{formatCurrency(call.amount)}</span>
                </div>
              ))}
            </div>
          </div>
