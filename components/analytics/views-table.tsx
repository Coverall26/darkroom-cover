            ...
            <p className="flex items-center gap-x-2 overflow-visible text-sm font-medium text-gray-800 dark:text-gray-200">
              {row.original.viewerEmail ? (
                <>
                  ...
                  {row.original.accreditationGateResponse && (
                    <BadgeTooltip
                      content={`Confirmed accredited investor (${row.original.accreditationGateResponse.accreditationType?.replace(/_/g, " ").toLowerCase()})`}
                      key="accreditation"
                    >
