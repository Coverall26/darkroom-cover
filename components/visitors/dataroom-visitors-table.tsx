                              ...
                              <p className="flex items-center gap-x-2 overflow-visible text-sm font-medium text-gray-800 dark:text-gray-200">
                                {view.viewerEmail ? (
                                  <>
                                    ...
                                    {view.accreditationGateResponse && (
                                      <BadgeTooltip
                                        content={`Confirmed accredited investor (${view.accreditationGateResponse.accreditationType?.replace(/_/g, " ").toLowerCase()})`}
                                        key={`accreditation-${view.id}`}
                                      >
                                        <ShieldCheckIcon className="h-4 w-4 text-amber-500 hover:text-amber-600" />
                                      </BadgeTooltip>
                                    )}
                                  </>
                                ) : (
