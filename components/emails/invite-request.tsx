        ...
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 w-[465px] p-5">
            <Text className="mx-0 mb-8 mt-4 p-0 text-center text-2xl font-normal">
              <span className="font-bold tracking-tighter">FundRoom Investor Portal</span>
            </Text>
            <Text className="font-semibold mx-0 mb-8 mt-4 p-0 text-center text-xl">
              New Access Request
            </Text>
            <Text className="text-sm leading-6 text-black">
              A new investor has requested access to the FundRoom Investor Portal.
            </Text>
            ...
            {quickAddUrl && (
              <>
                ...
                <Text className="text-sm leading-6 text-gray-600 text-center">
                  Click above to instantly grant access. Email will be pre-filled.
                </Text>
              </>
            )}
            <Section className="my-6 text-center">
            ...
            <Text className="text-sm leading-6 text-gray-600 text-center">
              {quickAddUrl 
                ? "Or click above to sign in and review the dataroom first."
