          ...
          <Container className="mx-auto my-10 w-[465px] p-5">
            ...
            <Text className="text-sm">
              {dataroomName ? (
                ...
                <>
                  Welcome to the FundRoom Investor Portal. You now have access to view 
            ...
            <Section className="mt-4">
              <Text className="text-sm">
                ...
                <Link
                  href="mailto:support@fundroom.ai"
                  target="_blank"
              ...
              <Text className="text-sm text-gray-400">The FundRoom Team</Text>
            </Section>
            <Footer />
          </Container>
        </Body>
