              ...
              <div className="text-sm text-muted-foreground">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <BadgeTooltip
                    ...
                    key="branding"
                    link="mailto:support@fundroom.ai?subject=Branding Help"
                  >
                  ...
                  <CardContent className="pt-6">
                    <div className="space-y-3">
                      ...
                      <div className="flex flex-wrap gap-2">
                        <div
                          className="relative h-10 w-10 cursor-pointer rounded-md bg-black shadow-sm ring-2 ring-gray-300 transition-all hover:ring-gray-400"
                        ...
                        <div
                          className="relative h-10 w-10 cursor-pointer rounded-md bg-blue-600 shadow-sm ring-2 ring-gray-300 transition-all hover:ring-gray-400"
                        ...
                        <div
                          className="relative h-10 w-10 cursor-pointer rounded-md bg-teal-600 shadow-sm ring-2 ring-gray-300 transition-all hover:ring-gray-400"
                          onClick={() => setBrandColor("#0d9488")}
                        >
                          {brandColor === "#0d9488" && (
                            <Check className="absolute left-1/2 top-1/2 h-5 w-5 -translate-x-1/2 -translate-y-1/2 text-white" />
                          )}
                        ...
                        <div
                          className="relative h-10 w-10 cursor-pointer rounded-md bg-purple-600 shadow-sm ring-2 ring-gray-300 transition-all hover:ring-gray-400"
                        ...
                        <div
                          className="relative h-10 w-10 cursor-pointer rounded-md bg-red-600 shadow-sm ring-2 ring-gray-300 transition-all hover:ring-gray-400"
                          onClick={() => setBrandColor("#dc2626")}
                        >
                          {brandColor === "#dc2626" && (
                            <Check className="absolute left-1/2 top-1/2 h-5 w-5 -translate-x-1/2 -translate-y-1/2 text-white" />
                          )}
