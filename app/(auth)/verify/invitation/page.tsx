...
const data = {
  description: "Accept your team invitation on FundRoom",
  title: "Accept Invitation | FundRoom",
  url: "/verify/invitation",
};

export const metadata: Metadata = {
  metadataBase: new URL(process.env.NEXT_PUBLIC_BASE_URL || "https://app.fundroom.ai"),
  title: data.title,
              ...
              {!isExpired && !isRevoked && (
                <>
                  <h3 className="text-balance py-1 text-sm font-normal text-gray-800">
                    You&apos;ve been invited to join a team on FundRoom
                  </h3>
              ...
              <div className="flex flex-col items-center justify-center">
                ...
                <div className="max-w-xl text-center">
                  <blockquote className="text-l text-balance leading-8 text-gray-100 sm:text-xl sm:leading-9">
                    <p>
                      FundRoom provides secure document sharing
