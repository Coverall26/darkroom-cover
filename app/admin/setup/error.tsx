...
/**
 * Error boundary for the GP Setup Wizard (/admin/setup).
 * Catches render errors in the 9-step wizard flow and provides
 * branded error UI with recovery options.
 */
export default function GPSetupError({
  error,
  reset,
}: {
    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#0A1628] px-4">
      <div className="max-w-md w-full text-center">
        ...
        <p className="text-gray-400 mb-2 text-sm">
          Something went wrong while loading the setup wizard.
