...
export default function NewFundWizard() {
  ...
  const [formData, setFormData] = useState({
    ...
    name: "",
    description: "",
    entityMode: "FUND" as "FUND" | "STARTUP",
    style: "TRADITIONAL",
    targetRaise: "",
    minimumInvestment: "",
    aumTarget: "",
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <button
                      type="button"
                      onClick={() => setFormData((prev) => ({ ...prev, entityMode: "FUND" }))}
                      className={`rounded-lg border p-4 text-left transition-colors ${
                        formData.entityMode === "FUND"
                          ? "border-primary bg-primary/5 ring-1 ring-primary"
                          : "border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600"
                      }`}
                    >
                      <p className="font-medium">GP Fund</p>
                      <p className="mt-1 text-xs text-muted-foreground">
                        LPA, capital calls, distributions, K-1s
                      </p>
                    </button>
                    <button
                      type="button"
                      onClick={() => setFormData((prev) => ({ ...prev, entityMode: "STARTUP" }))}
                      className={`rounded-lg border p-4 text-left transition-colors ${
                        formData.entityMode === "STARTUP"
                          ? "border-primary bg-primary/5 ring-1 ring-primary"
                          : "border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600"
                      }`}
                    >
                      ...
                      <p className="mt-1 text-xs text-muted-foreground">
                        SAFE, cap table, vesting, SPA/IRA
                      </p>
                    </button>
                  </div>
                </div>
                ...
                <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      {formData.entityMode === "FUND" ? "GP Fund" : "Startup"}
                    </span>
                  </div>
                  <div className="flex justify-between">
