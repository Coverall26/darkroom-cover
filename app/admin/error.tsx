...
/**
 * Error boundary for the entire GP admin portal (/admin/*).
 * Catches render errors in any admin page and provides branded error UI
 * matching the GP Deep Navy theme.
 */
