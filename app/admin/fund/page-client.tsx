...
import { EmptyState, AdminPageSkeleton } from "@/components/admin/shared/empty-state";
...
export default function FundDashboardClient() {
  ...
  if (loading) {
    return <AdminPageSkeleton showStats rows={4} statCount={4} />;
  }
            ...
            <CardContent>
              {data.funds.length === 0 ? (
                <EmptyState
                  icon={Landmark}
                  title="No funds yet"
                  description="Create your first fund to start tracking raises, investors, and capital flows."
                  actionLabel="Create Fund"
                  actionHref="/admin/funds/new"
                />
              ) : (
                        ...
                        <TableCell className="text-right">
                          <div className="flex items-center justify-end gap-1">
                            ...
                            <Button
                              ...
                              onClick={(e) => {
                                e.stopPropagation();
                                router.push(`/admin/settings?tab=fundInvestor&fundId=${fund.id}`);
                              }}
                              title="Fund Settings"
                            >
