...
const DEFAULT_BANNER_IMAGE = "/_static/fundroom-banner.png";

interface DataroomBrandPageClientProps {
  id: string;
}

export default function DataroomBrandPageClient({
  id,
}: DataroomBrandPageClientProps) {
          ...
          <div className="space-y-1">
            ...
            <p className="flex flex-row items-center gap-2 text-sm text-muted-foreground">
              ...
              <BadgeTooltip
                ...
                key="branding"
                link="https://fundroom.ai/help/dataroom-branding"
              >
