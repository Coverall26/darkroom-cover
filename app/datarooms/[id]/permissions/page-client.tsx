...
interface DataroomPermissionsPageClientProps {
  id: string;
}

export default function DataroomPermissionsPageClient({
  id,
}: DataroomPermissionsPageClientProps) {
              ...
              <div className="space-y-1">
                ...
                <p className="flex flex-row items-center gap-2 text-sm text-muted-foreground">
                  ...
                  <BadgeTooltip
                    ...
                    key="links"
                    link="https://fundroom.ai/help/links"
                  >
