...
interface DataroomGroupsPageClientProps {
  id: string;
}

export default function DataroomGroupsPageClient({ id }: DataroomGroupsPageClientProps) {
                ...
                <div className="space-y-1">
                  ...
                  <p className="flex flex-row items-center gap-2 text-sm text-muted-foreground">
                    ...
                    <BadgeTooltip
                      ...
                      key="groups"
                      link="https://fundroom.ai/help/granular-permissions"
                    >
