...
export default function PublicDataroomPageClient({
  ...
  const accentColor = brand?.accentColor || "#0066FF";
  const bannerImage = brand?.banner || "/_static/fundroom-banner.png";
  const logoImage = brand?.logo || "/_static/fundroom-logo-white.png";
