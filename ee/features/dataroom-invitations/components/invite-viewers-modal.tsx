              ...
              <div className="space-y-3 text-sm text-muted-foreground">
                ...
                <p className="text-xs">
                  ...
                  <span className="break-all text-foreground">
                    {selectedLink
                      ? `${process.env.NEXT_PUBLIC_BASE_URL || 'https://app.fundroom.ai'}/view/${selectedLink.slug ?? selectedLink.id}`
                      : "https://app.fundroom.ai/view/..."}
                  </span>
                </p>
                ...
                <p className="text-xs">
                  ...
                  <span className="text-foreground">support@fundroom.ai</span>
                </p>
                <p className="text-xs">
