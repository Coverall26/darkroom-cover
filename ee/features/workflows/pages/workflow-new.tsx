...
export default function NewWorkflowPage() {
  ...
  const [domain, setDomain] = useState<string>("fundroom.ai");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (domain !== "fundroom.ai" && !slug.trim()) {
    ...
    try {
      const response = await fetch(`/api/workflows?teamId=${teamId}`, {
        ...
        body: JSON.stringify({
          ...
          domain: domain === "fundroom.ai" ? undefined : domain,
          slug: domain === "fundroom.ai" ? undefined : slug.trim(),
        }),
      });
        ...
        <div className="max-w-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Select value={domain} onValueChange={setDomain}>
                  <SelectTrigger id="domain">
                    <SelectValue placeholder="fundroom.ai (default)" />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="fundroom.ai">fundroom.ai</SelectItem>
                    {domains?.map((d) => (
              ...
              {domain === "fundroom.ai" && (
                <p className="text-xs text-muted-foreground">
                  Entry URL will be generated automatically (e.g., fundroom.ai/view/clxxx...)
                </p>
              )}
            </div>
