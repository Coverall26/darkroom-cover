...
const SubscriptionRenewalReminderEmail = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>Your FundRoom subscription renews soon</Preview>
      <Tailwind>
        <Body className="mx-auto my-auto bg-white font-sans text-sm">
          <Container className="mx-auto my-10 w-[465px] p-5">
            ...
            <Text>
              Another year has come and gone, which means your annual FundRoom
            ...
            <Text>
              ...
              please visit your{" "}
              <a
                href="https://app.fundroom.ai/settings/billing"
                className="underline"
                target="_blank"
            ...
            {isOldAccount ? (
              <>
                <Hr />
                <Text className="text-gray-400">The FundRoom Team</Text>
              </>
            ) : (
              <Footer />
            )}
