...
// Session user type with optional createdAt (may not be present in JWT token)
// loginPortal indicates which portal was used to log in ("ADMIN" or "VISITOR")
export type CustomUser = NextAuthUser & Omit<PrismaUser, 'createdAt'> & {
  createdAt?: Date;
