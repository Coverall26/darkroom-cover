...
async function exportDocumentVisits(
  ...
  for (let i = 0; i < views.length; i++) {
    ...
    const rowData = [
      ...
      view.accreditationGateResponse ? "Yes" : "NaN",
      view.accreditationGateResponse?.accreditationType || "NaN",
      view.accreditationGateResponse?.createdAt?.toISOString() || "NaN",
...
async function exportDataroomVisits(
  ...
  for (let i = 0; i < dataroomViews.length; i++) {
    ...
    exportData.push({
      ...
      accreditationStatus: dataroomView.accreditationGateResponse
        ? "Yes"
        : "NaN",
      accreditationType:
        dataroomView.accreditationGateResponse?.accreditationType || "NaN",
      accreditationConfirmedAt:
        dataroomView.accreditationGateResponse?.createdAt?.toISOString() ||
        "NaN",
  ...
  exportData.forEach((view) => {
    if (view.documentViews.length === 0) {
      const rowData = [
        ...
        view.accreditationStatus,
        view.accreditationType,
        view.accreditationConfirmedAt,
        "NaN",
        "NaN",
        "NaN",
        "NaN",
