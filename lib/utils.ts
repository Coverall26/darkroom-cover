...
export const log = async ({
  ...
  try {
    ...
    // Slack notification failure is non-critical; log but don't propagate
    console.error("Slack log() failed:", e);
  }
};
...
export function constructMetadata({
  title = "FundRoom | Investor Portal",
  description = "Secure access to FundRoom AI investor documents and data room.",
  image = "/_static/fundroom-og.png",
  favicon = "/favicon.ico",
  noIndex = false,
}: {
  title?: string;
