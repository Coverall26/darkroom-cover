...
describe('PWA Support', () => {
  describe('Web Manifest', () => {
    const MANIFEST = {
      name: 'FundRoom',
      short_name: 'FundRoom',
      description: 'Investor portal for FundRoom LP management',
  ...
  describe('Service Worker', () => {
    ...
    describe('Cache Names', () => {
      ...
      const CACHE_NAMES = {
        STATIC: `fundroom-static-${CACHE_VERSION}`,
        DYNAMIC: `fundroom-dynamic-${CACHE_VERSION}`,
        API: `fundroom-api-${CACHE_VERSION}`,
      };
  ...
  describe('Install Prompt', () => {
    ...
    describe('Prompt UI', () => {
      ...
      it('should persist dismissal', () => {
        const DISMISS_KEY = 'fundroom-pwa-dismissed';
  ...
  describe('Meta Tags', () => {
    const META_TAGS = {
      ...
      'apple-mobile-web-app-title': 'FundRoom',
